...
- [x] Task 3：以模拟玩家执行完整命令树
- [x] Task 3：验证双 UUID 配置、补全和触发隔离
- [x] Task 3：验证消息、日志、实体和交互次数
- [x] Task 4：自动断言拒绝不新增区块票据
- [x] Task 4：覆盖不可实体 tick 邻区块和负坐标
- [x] Checkpoint B：命令合同与无副作用通过
