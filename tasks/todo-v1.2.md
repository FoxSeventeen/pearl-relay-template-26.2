...
- [x] Task 8：创建并推送 annotated `v1.2.0`
- [x] Task 8：发布正式 GitHub Release 并复核资产 digest
- [x] Task 8：获明确授权后停服部署 v1.2.0，验证启动、命令和回滚路径
...
- [x] 发布 JAR 不包含测试代码或夹具
- [x] 提交、tag、Release 与正式 JAR 一致，服务器既有版本和哈希已记录
